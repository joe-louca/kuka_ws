...
class CAMERAS():
    def __init__(self):
        ...
        cam1 = '/dev/video1'
        cam2 = '/dev/video9'
        vs1 = WebcamVideoStream1(src=cam1, fps=fps, width=width, height=height).start()
        ...
        while True:
            ...
            if not start_time == -1:
                timest = round(rospy.get_time() - start_time,2)
