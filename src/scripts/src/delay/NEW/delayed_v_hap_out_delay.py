...
class DELAY():
    ...
    def __init__(self):       
        ...
        rospy.init_node('delayed_v_hap_delay', anonymous=True)
        pub = rospy.Publisher('/delayed_delayed_v_hap_out', TwistStamped, queue_size=1)
        sub = rospy.Subscriber('/delayed_v_hap_out', TwistStamped, self.callback, queue_size=1)    
