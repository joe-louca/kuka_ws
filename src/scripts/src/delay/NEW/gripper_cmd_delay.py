...
class DELAY():
    ...
    def __init__(self):       
        ...
        rospy.init_node('gripper_delay', anonymous=True)
        pub = rospy.Publisher('/delayed_gripper_cmd', Int16, queue_size=1)
        sub = rospy.Subscriber('/gripper_cmd', Int16, self.callback, queue_size=1)    

        # Prepare messages
        pub_msg = Int16()
        self.callback_msg = Int16()
        self.checker = False
