...
bool operator==(const ::netft_utils::SetMaxRequest_<ContainerAllocator1> & lhs, const ::netft_utils::SetMaxRequest_<ContainerAllocator2> & rhs)
{
  return lhs.forceMax == rhs.forceMax &&
    lhs.torqueMax == rhs.torqueMax;
}
