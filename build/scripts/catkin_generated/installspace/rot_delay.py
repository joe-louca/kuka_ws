...
def rot_callback(msg):
    ...
    # Timestamp
    t = rospy.get_time()
    timestamped_rot = [rot[0], rot[1], rot[2], rot[3], rot[4], rot[5], rot[6], rot[7], rot[9], t]
    
    # Store and retrieve delayed msg
    rot, retrieved, delayed_tbl = add_delay(timestamped_ft, delayed_tbl)
