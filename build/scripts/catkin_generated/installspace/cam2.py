...
class CAMERAS:
    ...
    def __init__(self):
        ...
        if int(trial_id) == 0:
            path = '~/UserTrialData/P'+str(pp_id)+'/Baseline_taskcam2.mp4'
        else:
            path =  '~/UserTrialData/P'+str(pp_id)+'/T'+str(trial_id)+'_taskcam2.mp4'
        
        vid1_capture = cv2.VideoCapture('/dev/video0')
        ...
        while not rospy.is_shutdown():
            ...
            if success1:
                self.draw_text(frame1, 'Camera 2')
