...
echo_and_run cd "/home/joe/kuka_ws/src/universal_robot/ur_kinematics"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/joe/kuka_ws/src/universal_robot/ur_kinematics/setup.py" \
     \
    build --build-base "/home/joe/kuka_ws/build/universal_robot/ur_kinematics" \
    install \
    --root="${DESTDIR-/}" \
